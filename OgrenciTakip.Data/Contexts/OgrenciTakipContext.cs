...
using YavuzSav.OgrenciTakip.Data.OgrenciTakipMigration;
...
namespace YavuzSav.OgrenciTakip.Data.Contexts
{
    public class OgrenciTakipContext : BaseDbContext<OgrenciTakipContext, Configuration>
    {
        ...
        {
            modelBuilder.Conventions.Remove<PluralizingTableNameConvention>(); //çogullaþtýrmayý devre dýþý býrakýr
            modelBuilder.Conventions.Remove<OneToManyCascadeDeleteConvention>(); //(35:00 37. data katmaný) baðlantýlý nesneleri silme
            modelBuilder.Conventions.Remove<ManyToManyCascadeDeleteConvention>(); //çoka çok iliþkili verileri silme

            modelBuilder.Entity<Il>().HasMany(x => x.Ilce).WithRequired().WillCascadeOnDelete(true);//ile baðlý birden çok ilçe vardýr(3/6)(10. video 46:00) (ile baðlý ilçelerle beraber siler)
