    ...
    public partial class TopluOdemePlaniEditForm : BaseEditForm
    {
       ...
       public override void Yukle()
        ...
        private void ControlEnableChange(OdemeTipi odemeTipi)
        {
            ...
            txtBanka.ControlEnabledChange(txtBankaSube);  //banka seçilmeden banka sube seçilemez
        }
        ...
        private bool HataliGiris()
        {
            ...
            switch (_odemeTipi)
            {
                ...
                case OdemeTipi.Cek when txtBelgeNo.Value == 0:
                    Messages.HataliVeriMesaji("Belge No");
                    txtBelgeNo.Focus();
                    return true;
            }
        ...
        protected override void TaksitOluştur()
        {
