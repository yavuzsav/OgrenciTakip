...
namespace YavuzSav.OgrenciTakip.UI.Win.Functions
{
    public class TablePrintingFunctions
    {
        ...
        private static PrintableComponentLink _link;  //baskı önizlemede üst ve alt başlık eklemek için kullanılır
        private static PrintingSystem _ps;  //baskı önizlemede verilerin gözükeceği yer
        ...
        private static void RaporDokumu()
        {
            ...
            _tablo.OptionsPrint.PrintHeader = _dp.SutunBaslikleriniGoster == EvetHayir.Evet;
        ...
        private static void RaporuKagitaSigdir()
        {
            YazdirmaYonuAyarla();
