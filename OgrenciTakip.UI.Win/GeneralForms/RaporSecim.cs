...
using YavuzSav.OgrenciTakip.UI.Win.Reports.XtraReports.Fatura;
using YavuzSav.OgrenciTakip.UI.Win.Reports.XtraReports.Makbuz;
using YavuzSav.OgrenciTakip.UI.Win.Reports.XtraReports.Tahakkuk;
...
namespace YavuzSav.OgrenciTakip.UI.Win.GeneralForms
{
    public partial class RaporSecim : BaseListForm
    {
        ...
        protected override void DegiskenleriDoldur()
        {
            ...
            Navigator = smallNavigator1.Navigator;
        ...
        private IList<MyXtraReport> RaporHazirla()
        {
            ...
            topluRapor.PrintingSystem.ContinuousPageNumbering = false; //sayfa numaralandırma yapma
        ...
        protected override void Button_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (e.Item == btnYeniRapor)
            {
                ...
                RaporOlustur(KartTuru.OgrenciKartiRapor, RaporBolumTuru.TahakkukRaporlari, new OgrenciKartiRaporu());
